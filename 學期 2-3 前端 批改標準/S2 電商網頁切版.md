...
參考課程平台 (<a href="https://lighthouse.alphacamp.co/courses/51/assignments/1525" target="_blank">原文連結</a>)
...
1. 根據[指定目標頁面](https://alphacamp.github.io/tshirts-layout-2020/) 切版
   1. 使用純 CSS 完成切版，不得套用 Bootstrap 等前端框架。
商品圖片區塊，
   2. 使用 CSS Grid 系統進行排版 (含 RWD)，而圖片內部的細節和此頁面上其他區塊排版策略不限。
1. 使用指定圖片素材（請參照題目說明）
